...
contract UserRegister {
	...
	event CreateUser(address indexed _userAddress, string _username, string _userId); // 创建User事件
	event UpdateUser(address indexed _userAddr, string _userName, string _userId);
	...
	//创建用户信息
	function createUser(address _userAddress, string _username, string _pwd, string _userId, string _cardId) public returns(bool) {
	...
	//获取用户个人信息
	function findUser(address _userAddress) public constant returns (address,string, string, uint, uint) {
	...
	// 修改用户信息
	function updateUser(address _userAddr, string _userName, string _pwd, string _newpwd, string _userId) public returns(bool) {
